...
paste ../h_eng.txt  ../h_telugu.txt h_ang.txt di.txt pu.txt dp.txt ri.txt ru.txt rri.txt r1p.txt r2p.txt r3p.txt xa.txt Du.txt > heads_raw.txt
rm ../h_eng.txt  ../h_telugu.txt h_ang.txt di.txt pu.txt dp.txt ri.txt ru.txt rri.txt r1p.txt r2p.txt r3p.txt xa.txt Du.txt 
